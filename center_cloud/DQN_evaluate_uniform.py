...
LOG_PATH = f"DQN_evaluate_uniform_0.75_{timestamp}.csv"
...
BASELINE_BURST_LENGTH = 60           # “高潮”：连续发送 action=1 的数量
BASELINE_GAP_LENGTH = 20             # “低潮”：连续发送 action=0 的数量 (必须是 BURST_LENGTH 的3倍)
